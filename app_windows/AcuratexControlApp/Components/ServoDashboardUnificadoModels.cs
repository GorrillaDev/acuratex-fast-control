// [ACURATEX] Modelos de apoyo del tablero servo unificado.
...
///
/// [QUIEN LA USA]
/// La usa la vista unificada de servo.
///
/// [CUANDO SE USA]
...
/// </summary>
public sealed class ServoDashboardUnificadoToggle
{
    /// <summary>
    /// [POR QUE EXISTE]
    ...
    ///
    /// [QUIEN LO LLAMA]
    /// Lo llama el componente de servo unificado cuando arma sus listas de controles.
    ///
    /// [CUANDO SE EJECUTA]
    ...
    /// </summary>
    public ServoDashboardUnificadoToggle(string key, string onText, string offText)
    {
        Key = key;
        OnText = onText;
        OffText = offText;
...
///
/// [QUIEN LA USA]
/// La usa la vista de servo unificada.
///
/// [CUANDO SE USA]
...
/// </summary>
public sealed class ServoDashboardUnificadoPosition
{
    /// <summary>
    /// [POR QUE EXISTE]
    ...
    /// </summary>
    public ServoDashboardUnificadoPosition(int number)
    {
        Number = number;
    }
...
///
/// [FLUJO ACURATEX]
/// Click de UI -> `ServoDashboardUnificadoTurnsChange` -> servicio -> comando.
///
/// [EQUIVALENCIA MCU]
...
/// </summary>
public readonly record struct ServoDashboardUnificadoTurnsChange(int PositionNumber, int Delta);
...
///
/// [FLUJO ACURATEX]
/// Editor de posicion -> `ServoDashboardUnificadoTargetChange` -> servicio -> firmware.
///
/// [EQUIVALENCIA MCU]
...
/// </summary>
public readonly record struct ServoDashboardUnificadoTargetChange(int PositionNumber, decimal Target);
